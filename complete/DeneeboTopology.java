...
import complete.AuthenticationBolt;
import complete.CassandraWriteBolt;
import complete.JSONConverterBolt;
import complete.RuleBolt;
...
public class DeneeboTopology {
	public static void main(String[] args) throws AlreadyAliveException, InvalidTopologyException 
	{
		...
		*/
		PropertyConfigurator.configure("/home/abhinab/Cloud_Proj/complete/deneebolog4j/log4j.properties");
		/**
		 * Topology definition
		 */
